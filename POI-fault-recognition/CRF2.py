...
def CRFNFL_Denoise(traindata, Validationdata, ntree=100, niThreshold=11):
    # 建立ntree棵树
    if ntree < 1:
        print('The value of ntree at least is 1.')
        return 0
    ...
    return denoise_data, noiseForest
...
def crfnfl_all(traindata, testdata, Validationdata):
    ...
    print("去噪后精度")
    pre6 = CRFNFL_kNN(traindata, Validationdata, testdata, ntree=23, niThreshold=6)
    #pre7 = CRFNFL_BPNN(traindata, Validationdata, testdata, ntree=5, niThreshold=2)
    pre8 = CRFNFL_SVM(traindata, Validationdata, testdata, ntree=24, niThreshold=6)
    pre9 = CRFNFL_LR(traindata, Validationdata,  testdata, ntree=23, niThreshold=6)
    pre10 = CRFNFL_Cart(traindata, Validationdata, testdata, ntree=32, niThreshold=6)
    gbdt_pre1 = CRFNFL_GBDT(traindata, Validationdata, testdata)
    xgb_pre1 = CRFNFL_XGB(traindata, Validationdata, testdata)

    print("knn = :", pre1, pre6)
    #print("bpnn = :", pre2, pre7)
    print("svm = :", pre3, pre8)
    print("lr = :", pre4, pre9)
    print("cart = :", pre5, pre10)
    print("gbdt = :", gbdt_pre0, gbdt_pre1)
    print("xgb = :", xgb_pre0, xgb_pre1)
